...
#include "../../../client/app/workerwindow.h"
...
static constexpr auto qt_meta_stringdata_CLASSWorkerWindowENDCLASS = QtMocHelpers::stringData(
    "WorkerWindow",
    "logout",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSWorkerWindowENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSWorkerWindowENDCLASS_t qt_meta_stringdata_CLASSWorkerWindowENDCLASS = {
    {
        QT_MOC_LITERAL(0, 12),  // "WorkerWindow"
...
void WorkerWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (WorkerWindow::*)();
            if (_t _q_method = &WorkerWindow::logout; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
